...
export default function Faq() {
  ...
  const filteredFaqs = faqs.filter(faq => {
    const matchesCategory = selectedCategory === 'all' || faq.category_id === parseInt(selectedCategory);
                  ...
                  >
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <div className={`text-sm px-2 py-1 rounded ${
                        ...
                        {categories.find(c => c.id === faq.category_id)?.name || 'Sans catégorie'}
                      </div>
                    </div>
                            ...
                            <li key={relatedFaq.id}>
                              <button
                                onClick={() => {
                                  ...
                                  document.getElementById(`faq-${relatedFaq.id}`)?.scrollIntoView({
                                    behavior: 'smooth',
                                    block: 'center'
                                  });
                                }}

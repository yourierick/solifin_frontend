          ...
          >
            ...
            >
              <div className="p-4 border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}">
                ...
                >
                  Les offres d'emploi publiées sont certifiées. Aucun frais
                  n'est exigé pour le dépôt des candidatures.
                </p>
                <div
              ...
              {/* Filtres */}
              <div
                className={`flex flex-wrap gap-2 p-4 border-t ${

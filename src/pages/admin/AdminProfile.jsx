        ...
        <div className="px-6 pt-20 pb-8">
          ...
          {isEditing ? (
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Informations administrateur</h3>
                <dl className="space-y-4">
                  <div>
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-base text-gray-900 dark:text-white">{user.last_login_at || '-'}</dd>
                  </div>
                </dl>
              </div>
            </div>
